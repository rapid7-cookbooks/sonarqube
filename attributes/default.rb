...
default['sonarqube']['rpm']['uri'] = 'http://downloads.sourceforge.net/project/sonar-pkg/rpm/noarch/'
default['sonarqube']['deb']['uri'] = 'http://downloads.sourceforge.net/project/sonar-pkg/deb/binary/'
default['sonarqube']['deb']['checksum'] = 'f6d4c647c1280b8d3b146dbf78e32ca52b8a99e8809193d50d033bbe0b1606f0'
